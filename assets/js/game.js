...
console.log(playerName, playerAttack, playerHealth, playerName + " has " + playerMoney + " dollars");
...
var fight = function () {
    ...
    if (promptFight === "fight" || promptFight === "FIGHT") {
        ...
        // if player choses to skip--END NESTED conditionals--
    }
        ...
        //if no(false), ask question to fight by running fight() again
        else {
            fight();
        }
